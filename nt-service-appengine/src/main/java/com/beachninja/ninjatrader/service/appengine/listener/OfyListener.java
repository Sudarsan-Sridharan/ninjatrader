...
package com.beachninja.ninjatrader.service.appengine.listener;
...
public class OfyListener implements ServletContextListener {
  private static Logger LOG = LoggerFactory.getLogger(OfyListener.class);

  public static void register() {
    ObjectifyService.register(AlgorithmDocument.class);
    ObjectifyService.register(PriceDocument.class);
    ObjectifyService.register(UserDocument.class);
  }
