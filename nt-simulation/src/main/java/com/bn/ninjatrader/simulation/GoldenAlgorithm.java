...
////                    )),
//
////                ConditionalStatement.withName("Pullback w/ 5 bars")
////                    .condition(Conditions.and(
////                        eq(HistoryValue.of(PRICE_LOW).inNumOfBarsAgo(4), LowestValue.of(PRICE_LOW).fromBarsAgo(5)),
////                        gte(PcntChangeValue.of(HistoryValue.of(PRICE_LOW).inNumOfBarsAgo(4), HistoryValue.of(PRICE_LOW).inNumOfBarsAgo(1)), PULLBACK_SENSITIVITY),
////                        gte(PcntChangeValue.of(HistoryValue.of(PRICE_LOW).inNumOfBarsAgo(4), HistoryValue.of(PRICE_LOW).inNumOfBarsAgo(5)), PULLBACK_SENSITIVITY)
////                    ))
////                    .then(MultiStatement.of(
////                        MarkStatement.withColor("red").numOfBarsAgo(4).marker(Marker.ARROW_BOTTOM)
////                    )),
//
